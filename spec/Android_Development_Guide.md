...
* If a build fails or the app crashes, immediately read the `crash_report.txt` file located in the root directory. The `dev_cycle.bat` script automatically pipes all ADB native errors (`*:E`) into this file.