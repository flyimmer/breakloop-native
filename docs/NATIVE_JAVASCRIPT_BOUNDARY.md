...
- Reset `t_intention` and `t_appSwitchInterval`
...
- `SYSTEM_SURFACE_ARCHITECTURE.md` - System Surface architecture details
- `docs/INTENTION_TIMER_APP_SWITCH_FIX.md` - Intention timer implementation
- `docs/QUICK_TASK_ZERO_USES_FIX.md` - Quick Task implementation
